...
public class TimeWindpw_Session {
...
//        WindowedStream<Tuple2<String, Integer>, Tuple, TimeWindow> timeWindowDS = keyedStream.timeWindow(Time.seconds(5));
        WindowedStream<Tuple2<String, Integer>, Tuple, TimeWindow> timeWindowDS = keyedStream.window(ProcessingTimeSessionWindows.withGap(Time.seconds(5)));
